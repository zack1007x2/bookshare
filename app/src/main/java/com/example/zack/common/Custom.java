package com.example.zack.common;
...
public class Custom {
    ...
    //定义服务器的ip和端口号
    public static final String SERVER_HOST = "10.40.242.170";
    ...
    //收到了SocketMessage消息
    public static final String ACTION_SOCKET_MESSSAGE = "com.example.zack.socketmessage";
    //Socket当前的状态
